            ...
            Component({
                ...
                methods: {
                    _videoListChanged: function _videoListChanged(newVal) {
                        var _this = this;
                        var data = this.data;
                        if (!(data.curQueue[0] && newVal[0] && data.curQueue[0].id == newVal[0].id)) {
                            if (!(data.prevQueue[0] && newVal[0] && data.prevQueue[0].id == newVal[0].id)) {
                    ...
                    animationfinish: function animationfinish(e) {
                        ...
                        this.triggerEvent('change', { activeId: curQueue[current].index });
                    ...
                    onStoreAttention(e) {
                        this.trigger(e, 'storeattention');
                    },
                    storeAttentionHandle(e) {
                        let key = "curQueue[" + this.data._last + "].storeFollowStatus";
                        this.setData({
                            [key]: 1
                        })
                    },
                    ...
                    likehandle(e) {
                        let key = "curQueue[" + this.data._last + "].followStatus";
                        if (this.data.curQueue[this.data._last].followStatus == 0) {
                            let that = this;
                            this.setData({
                                likeAnim: true,
                                [key]: 1
                    ...
                    gooddetail(e) {
                        if (e.currentTarget.dataset.type == 3) {
                            wx.navigateTo({
                                url: '/packageStore/pages/storeGoodsDetail/storeGoodsDetail?goodsId=' + e.currentTarget.dataset.id,
                            })
                        } else {
                            wx.navigateTo({
