...
//连接GoEasy
IMService.prototype.connectIM = function (user) {
    this.currentUser = new CurrentUser(user.ImId, user.nickName, user.photoUrl);
    //初始化IM相关的监听器
...
IMService.prototype.subscribeGroupMessage = function (groupId) {
    var groupIds = [];
